---
title: 「Hadoop」Hadoop常用命令
date: 2023-07-27 13:41:45
tags: [Hadoop, 大数据]
---
### [](#FS-Shell "FS Shell")FS Shell
...
##### [](#copyFromLocal "copyFromLocal")copyFromLocal
    
使用方法：hadoop fs -copyFromLocal URI  
除了限定源路径是一个本地文件外，和put命令相似。
    
##### [](#copyToLocal "copyToLocal")copyToLocal
...
##### [](#movefromLocal "movefromLocal")movefromLocal
